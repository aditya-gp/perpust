...
<div style="position: relative; left: 25%">
	<table>
		...
		foreach ($anggota as $a) {
			...
			<tr><th>Alamat</th><th>:</th><th><?php echo $a->alamat; ?></th></tr> <?php } ?>
			<tr>
				<td colspan="3">
					<br/><br/>
					<div class="page-header">
						...
						<table class="table table-bordered table-striped table-hover" id="table-datatable" >
							...
							<tbody>		
								...
								foreach($peminjaman as $b){
									...
									<tr>
										<td><?php echo $no++; ?></td>
										<td><img src="<?php echo base_url();?>assets/upload/<?php echo $b->gambar; ?>" width="70"></td> <td style="max-width: 200px"><?php echo $b->judul_buku; ?></td>
